...
<div class="flex flex-1 justify-center items-start">
  <div class="bg-white shadow-lg rounded-lg p-4 w-full max-w-5xl" style="background-color: #f8f8ff;">
      ...
      <div class="flex justify-between items-center mt-6 mb-4 w-full">
        ...
        <!-- Filtro de estados -->
        <select id="estado-filter" class="px-6 py-3 rounded-full border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-700 bg-white shadow-lg transition-all duration-300 ease-in-out hover:bg-gray-50" onchange="filtrarEstado()">
