document.addEventListener('DOMContentLoaded', () => {
    ...
    let posicoesPadrao = {
        posicaoYInicialDente: 100,
        margemXEntreDentes: 5,
        margemYEntreDentes: 20
    }

    const tamanhoTelaReferencia = 950
    const alturaTelaReferencia = 400
 ...
 */
    const resizeCanvas = () => {
        ...
        camada1.width = camada2.width = camada3.width = camada4.width = camadaPincel.width = 950;
        camada1.height = camada2.height = camada3.height = camada4.height = camadaPincel.height = 400;
    
    
        valoresBase = {
            x: (camada1.width * 24) / tamanhoTelaReferencia,
            y: (camada1.height * 20) / tamanhoTelaReferencia,
            largura: (camada1.width * 70) / tamanhoTelaReferencia,
            altura: (camada1.height * 150) / tamanhoTelaReferencia
        };
        
        posicoesPadrao.margemXEntreDentes = (camada1.width * 6) / tamanhoTelaReferencia * 1.5; // Aumentar
        posicoesPadrao.margemYEntreDentes = (camada1.height * 150) / tamanhoTelaReferencia * 1.5; // Aumentar
        posicoesPadrao.posicaoYInicialDente = (camada1.height * 200) / tamanhoTelaReferencia;
    
        tamanhoColuna = camada1.width / 21;  
        tamanhoDente = (tamanhoColuna - (2 * posicoesPadrao.margemXEntreDentes)) * 1.5;  // Aumentar
    ...
    resizeCanvas() // Llamar al redimensionado inicial
